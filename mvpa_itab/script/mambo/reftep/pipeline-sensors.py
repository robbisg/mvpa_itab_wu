...
_default_options = {                     
                       ...
                       'estimator__clf': [
                           ...
                           MLPRegressor(hidden_layer_sizes=(96, )),
                           MLPRegressor(hidden_layer_sizes=(96, 24)),
                           MLPRegressor(hidden_layer_sizes=(24, )),
                           SVR(C=1),
                           SVR(C=10),
                           Lasso(alpha=0.5),
                        ],                          
...
for conf in iterator:
    ...
    try:
        a = AnalysisPipeline(conf, name="reftep+sensors+singleregression").fit(**kwargs)
        a.save()
