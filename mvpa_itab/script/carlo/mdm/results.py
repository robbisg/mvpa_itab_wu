...
[ax1[0,j].set_title(labels[j]) for j in range(len(unique_roi_val))]
[ax2[0,j].set_title(labels[j]) for j in range(len(unique_roi_val))]
[ax1[2,j].set_xlabel('frame') for j in range(len(unique_roi_val))]
[ax2[2,j].set_xlabel('frame') for j in range(len(unique_roi_val))]

[ax1[i,0].set_ylabel(unique_evidences[i]) for i in range(len(unique_evidences))]
[ax2[i,0].set_ylabel(unique_evidences[i]) for i in range(len(unique_evidences))]
