...
class ScriptConfigurator(object):
    ...
    def __init__(self, **kwargs):
        ...
        if 'prepro' in self._default_options:
            self._prepro = self._default_options['prepro']
    ...
    def _get_fname_info(self):
        ...
        for keyword in ["sampleslicer", "targettrans"]:
            if keyword in self._prepro:
                
                params_ = self._get_params(keyword)
                if keyword == "sampleslicer":
